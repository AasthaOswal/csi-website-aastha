                ...
                <div className="flex flex-col md:flex-row gap-8 h-full justify-between">
                    ...
                    <form className="bg-slate-800 p-8 rounded-2xl shadow-xl space-y-6 flex-grow" onSubmit={(e)=>e.preventDefault()}>
                        ...
                        <div className="text-center">
                            <button
                                type="submit"
                                className="bg-teal-400 hover:bg-teal-300 active:bg-teal-500 active:scale-95 text-slate-950 font-semibold px-8 py-3 rounded-xl transition-all duration-200 ease cursor-pointer "
                            >
                                Send Message
                            </button>
                        </div>
